...
with col1:
    create_card("Médical", "Données de suivi médical et blessures.", "🏥", "app_medical.py")
with col2:
    create_card("Nutrition", "Suivi du poids, MG%, et remarques nutrition.", "🍎", "app_nutrition.py")
with col3:
    create_card("Wellness", "Suivi quotidien pré et post-entrainement.", "🧘", "app_wellness.py")
